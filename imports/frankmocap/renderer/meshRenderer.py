...
class meshRenderer(glRenderer):
    ...
    def __init__(self, width=1600, height=1200, name='GL Renderer',
                ...
                frankmocap_path='./imports/frankmocap_2/'): ## ADDEd
        ...
        for key in self.program_files:
            self.program_files[key]=[frankmocap_path+renderer_pth for renderer_pth in self.program_files[key]]
