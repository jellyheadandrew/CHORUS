...
class SMPL(_SMPL):
    ...
    def __init__(self, *args, **kwargs):
        ...
        JOINT_REGRESSOR_TRAIN_EXTRA = os.path.join(
            FRANKMOCAP_DIR,
            'extra_data/body_module/data_from_spin//J_regressor_extra.npy')
    ...
    def forward(self, *args, **kwargs):
        ...
        self.joints = torch.cat([self.smpl_joints, extra_joints], dim=1)               #[N, 24 + 21, 3]  + [N, 9, 3]
        joints = self.joints[:, self.joint_map, :]
