...
def run_hand_mocap(args, bbox_detector, hand_mocap, visualizer):
    ...
    while True:
        ...
        if load_bbox:
            ...
            body_pose_list, body_bbox_list, hand_bbox_list, raw_hand_bboxes = detect_output # hand_bbox_list: list of detected dictionary of left_hand, right_hand bbox (x,y,w,h) form
